    ...
    in
    {
      ...
      programs.firefox = {
        ...
        profiles.${myconfig.constants.user or "krit"} = {
          ...
          # internal Firefox Settings (about:config)
          settings = {
            ...
            "browser.download.dir" = "/Users/${myconfig.constants.user or "krit"}/Downloads";
            "browser.download.lastDir" = "/Users/${myconfig.constants.user or "krit"}/Downloads";
