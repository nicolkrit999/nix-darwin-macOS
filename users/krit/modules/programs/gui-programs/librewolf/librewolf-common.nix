  ...
  home.ifEnabled =
    ...
    let
      ...
      commonSettings = toolbarSettings // {
        ...
        "ui.systemUsesDarkTheme" = if polarity == "dark" then 1 else 0;
        "browser.in-content.dark-mode" = polarity == "dark";
    ...
    in
    {
      ...
      programs.librewolf = {
        ...
        profiles = {
          default = (
            import ../../../../../../templates/krit/librewolf-profiles/librewolf-profile-default.nix {
              inherit
                pkgs
                addons
                searchConfig
                ...
                ;
              vars = {
                inherit user polarity;
              };
            }
          );

          privacy = (
            import ../../../../../../templates/krit/librewolf-profiles/librewolf-profile-privacy.nix {
              inherit
                pkgs
                addons
                searchConfig
